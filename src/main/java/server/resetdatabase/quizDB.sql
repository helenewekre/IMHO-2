...
CREATE TABLE `Answer` (
  ...
  CONSTRAINT `optionRef` FOREIGN KEY (`option_id`) REFERENCES `Option` (`idOption`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `Option` (
  ...
  CONSTRAINT `questionRef` FOREIGN KEY (`question_id`) REFERENCES `Question` (`idQuestion`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Question` (
  ...
  KEY `quizRef` (`quiz_id`),
  CONSTRAINT `quizRef` FOREIGN KEY (`quiz_id`) REFERENCES `Quiz` (`idQuiz`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `Quiz` (
  ...
  KEY `idRef` (`idCourse`),
  CONSTRAINT `idRef` FOREIGN KEY (`idCourse`) REFERENCES `Course` (`idCourse`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
